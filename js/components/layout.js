...
<footer class="footer" role="contentinfo">
  <div class="container">
      ...
      <div class="footer__brand">
        ...
        <div class="footer__social">
          ...
          <a href="#" class="footer__social-link" aria-label="LinkedIn">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-4 0v7h-4v-7a6 6 0 0 1 6-6z"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="4" r="2"/></svg>
          </a>
      ...
      <div>
        ...
        <div class="footer__contact-item">
          ...
          <div class="footer__contact-text">
            ...
            ${l==='ar'?'الرياض، المملكة العربية السعودية':'Riyadh, Saudi Arabia'}
          </div>
        </div>
        <div class="footer__contact-item">
          <div class="footer__contact-icon" aria-hidden="true">
    ...
    <div class="footer__bottom">
      <p class="footer__copyright">${t('footer.rights')}</p>
  ...
  _ensurePanel() {
    ...
    const TX = {
      ar: {
        ...
        addresses:'عناواني المحفوظة', tracking:'تتبع الطلبات',
